...
public class VmwareGuestOsMapper {
	...
	static {
        ...
        s_mapper.put("Windows 8 (32-bit)", VirtualMachineGuestOsIdentifier.windows8Guest);
        s_mapper.put("Windows 8 (64-bit)", VirtualMachineGuestOsIdentifier.windows8_64Guest);
        s_mapper.put("Windows Server 8 (64-bit)", VirtualMachineGuestOsIdentifier.windows8Server64Guest);

                s_mapper.put("Apple Mac OS X 10.6 (32-bit)", VirtualMachineGuestOsIdentifier.darwin10Guest);
                s_mapper.put("Apple Mac OS X 10.6 (64-bit)", VirtualMachineGuestOsIdentifier.darwin10_64Guest);
                s_mapper.put("Apple Mac OS X 10.7 (32-bit)", VirtualMachineGuestOsIdentifier.darwin11Guest);
                s_mapper.put("Apple Mac OS X 10.7 (64-bit)", VirtualMachineGuestOsIdentifier.darwin11_64Guest);
